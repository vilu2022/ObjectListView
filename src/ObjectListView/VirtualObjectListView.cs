  ...
  public class VirtualObjectListView : ObjectListView
  {
    ...
    protected new virtual int VirtualListSize
    {
      ...
      set
      {
        ...
        //base.VirtualListSize = value;   // QUESTO NON FUNZIONA

#if NET8_0_OR_GREATER

        GetVirtualListSizeField(this) = value;
...
/*         
          // This works on .NET 7 and later
          // fix the issue https://github.com/ennerperez/ObjectListView/issues/4
          if (virtualListSizeFieldInfo is null)
          {
            virtualListSizeFieldInfo = typeof(System.Windows.Forms.ListView).GetField("VirtualListSize", BindingFlags.NonPublic | BindingFlags.Instance);
          }
  */        
          // If we can't find the field, then we are probably running on a version of .NET that doesn't support virtual lists
...
#if NET8_0_OR_GREATER
    [System.Runtime.CompilerServices.UnsafeAccessor(System.Runtime.CompilerServices.UnsafeAccessorKind.Field, Name = "_virtualListSize")]
